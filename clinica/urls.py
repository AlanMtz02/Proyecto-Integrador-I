...
urlpatterns = [  
    ...
    path('expediente/<int:paciente_id>/', views.detalle_paciente, name='detalle_paciente'), #Es la de notas
    ...
    path('expediente/<int:paciente_id>/notas/', views.expediente_notas, name='expediente_notas'),
